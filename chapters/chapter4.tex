...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{mnv2_cm.png}
...
\begin{table}[h!]
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[scale=0.3]{rn50_cm.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{enb0_cm.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{iv3_cm.png}
...
\begin{table}[h!]
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[scale=0.3]{dn_121_cm.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{vit_cm.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.5]{model_performance.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{latencies.png}
